    ...
    <div id="wrapper">
        <div id="header">
            <div class="site">
                ...
                <p>
                    <%= CY_MVC.OnlineClient.OnlineClientHelper.Count %>
                </p>
            </div>
        </div>
        <div id="container">
            <div id="content">
                ...
                <script type="text/javascript">
                    function GetCommand() {
                        CY.Ajax("/cmd.ashx", "Test", {}, function (data) {
                            alert(data);
                        });
                    }
                    function GetCommandClass() {
                        CY.Ajax("/cmd.ashx", "User.Login", {}, function (data) {
                            alert(data);
                        });
                    }
                    function GetCommandUserClass() {
                        CY.Ajax("/user.ashx", "Login", {}, function (data) {
                            alert(data);
                        });
                    }
